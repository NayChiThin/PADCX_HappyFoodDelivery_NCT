...
import kotlinx.android.synthetic.main.popular_restaurant_list.view.*

class PopularRestaurantListViewHolder(itemView:View,delegate:RestaurantItemDelegate) : BaseViewHolder<RestaurantVO>(itemView) {
    init {
